...
function rarityMetaV2(string $rarity): array {
    return match ($rarity) {
...
<div class="container py-4">
  <div class="d-flex flex-wrap gap-2 align-items-center justify-content-between mb-3">
    ...
    <h2 class="mb-0">🧪 Collection V2</h2>
    <a href="collection.php" class="btn btn-outline-info">Voir la collection classique</a>
  </div>

  <div class="row g-3">
    <?php foreach ($cards as $c): ?>
      <?php $rarity = rarityMetaV2($c['rarity']); ?>
          ...
          <div class="tcg-card-v2-inner type-<?= strtolower($c['type']) ?>">
            ...
            <div class="card-v2-bottom">
              <div class="card-v2-meta-row">
                ...
                <div class="card-chip">⚡ <?= (int)$c['speed'] ?></div>
              </div>
